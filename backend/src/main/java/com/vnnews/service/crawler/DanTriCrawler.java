...
@Component
@Slf4j
public class DanTriCrawler extends AbstractNewsCrawler {

    public DanTriCrawler(CrawlConfigRepository crawlConfigRepository) {
    ...
    protected List<String> fetchArticleUrls(CrawlConfig config) throws Exception {
        ...
        return feed.getEntries().stream()
                ...
                .filter(link -> link != null && link.contains("dantri.com.vn"))
                .limit(20)
                .toList();
    }
}
