...
@Component
@Slf4j
public class TuoiTreCrawler extends AbstractNewsCrawler {

    public TuoiTreCrawler(CrawlConfigRepository crawlConfigRepository) {
    ...
    protected List<String> fetchArticleUrls(CrawlConfig config) throws Exception {
        ...
        return feed.getEntries().stream()
                ...
                .filter(link -> link != null && link.contains("tuoitre.vn"))
                .limit(20)
                .toList();
    }
}
